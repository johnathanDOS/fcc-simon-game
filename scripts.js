...
const rTone = new Audio ('./sounds/simonSound1.mp3')
const gTone = new Audio ('./sounds/simonSound2.mp3')
const bTone = new Audio ('./sounds/simonSound3.mp3')
const yTone = new Audio ('./sounds/simonSound4.mp3')
